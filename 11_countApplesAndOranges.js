...
function countApplesAndOranges(s, t, a, b, apples, oranges) {
    ...
    for (var apple of apples) {
        var appleAbs = apple + a;
        if ((appleAbs >= s) && (appleAbs <= t)) fruitHits.apples++;
    }
    for (var orange of oranges) {
        var orangeAbs = orange + b;
        if ((orangeAbs >= s) && (orangeAbs <= t)) fruitHits.oranges++;
    }
    console.log(fruitHits.apples + "\n" + fruitHits.oranges);
}
